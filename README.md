...
### Man page
    ...
    DESCRIPTION
           ...
           should not be specified in this case.
           ...
           --dotall
                  ...
                  line.  Beware that `.*' dot greedy repeats match all  input,  to
                  be avoided.
           ...
           -x, --line-regexp
                  ...
                  option  does not apply to -f FILE patterns to allow -f FILE pat-
                  terns to narrow or widen the PATTERN search.
