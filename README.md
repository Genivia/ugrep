...
ugrep    1.5.0  | **0.11** | 0.07     | **1.15** | **1.08** | **0.99** | **0.97** | **0.37** | **0.10** | **0.20** |
...
--------
    ...
    DESCRIPTION
           ...
           -J NUM, --jobs=NUM
                  ...
                  simultaneously.  -J1 disables threading: matching files are out-
                  put in the same order as the specified files.
