...
### Man page
    ...
    DESCRIPTION
           ...
           --bool, -%
                  ...
                  lines with `C'.  Note that all subpatterns in  a  Boolean  query
           ...
           --zmax=NUM
                  ...
                  of compressed files and archives stored within archives  for  up
                  to NUM recursive levels deep.  The default --zmax=1 only permits
                  ...
                  and  de-archiving  steps.   Larger  NUM values gradually degrade
                  performance.
    ...
    ugrep 3.5.0                    January 05, 2022                       UGREP(1)
