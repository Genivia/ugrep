...
--------
    ...
    SYNOPSIS
           ugrep [-bcDdEFGgHhikLlmNnOoqRrsTtVvwXxYyZz] [-A NUM] [-B NUM] [-C[NUM]]
    ...
    DESCRIPTION
           ...
           -t TYPES, --file-type=TYPES
                  ...
                  `java', `js', `json', `jsp', `less', `lex', `lisp', `lua', `m4',
                  `make',  `matlab',  `objc', `objcpp', `ocaml', `parrot', `perl',
                  `php', `python', `R', `rst', `ruby', `rust', `scala',  `scheme',
